...
Such a task might be given to a standalone tactic for beta-reducing terms.\footnote{In reality, such low-level functionality may not outweigh the overhead of making a tactic standalone. See <Sec 4??> for more realistic examples of tactics albeit in less detail.}
